...
fn main() {
	...
	print2(1, "Clone matrix and delete (0,0) ")
	mut mat2 := mat1.clone()
	mat2.del(0, 0)
	print2(2, "First Matrix remains de same ")
	mat1.printm2(2)
	print2(2, "Second Matrix without 0-0 element")
	mat2.printm2(2)
	print2(2, "Second Matrix add (2-i) to the 1-1 element")
	mut z21 := Cplx{2, -1}
	mat2.add(1, 1, z21)
	mat2.printm2(2)
	print2(2, "Second Matrix put (5i) to the 2-0 element  (rewrite)")
	mut z05 := Cplx{0, 5}
	mat2.put(2, 0, z05)
	mat2.printm2(2)
	glob.title(
	...
	mut mat3 := &Matrix{{0:cero},0,0}
	print1(" empty matrix: --> ")
	mat3.printm1()
	
	print1(" add 1 to (3,3) and (5,5) elements. matrix: --> ")
	mat3.add_one(3, 3)
	mat3.add_one(5, 5)
	mat3.printm2(2)
	
	print1(" add 1 to (3,3) element. matrix: --> ")
	mat3.add_one(3, 3)
	mat3.printm2(2)
